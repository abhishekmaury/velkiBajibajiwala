const wrapper = document.querySelector('.gallery-images');
// const colors = ["#f38630", "#6fb936", "#ccc", "#6fb936"];
const boxes = gsap.utils.toArray('.ambassador-image');
...
const loop = horizontalLoop(boxes, {
    ...
    onChange: (element, index) => {
        ...
        activeElement && activeElement.firstElementChild.classList.remove('active');
...
/* 
Helper function to make a group of elements animate along the x-axis in a seamless, responsive loop.
*/
